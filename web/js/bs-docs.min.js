...
!function(t,e){
	"object"==typeof exports&&"undefined"!=typeof module?
		module.exports=e():"function"==typeof define&&define.amd?
			define(e):t.bsCustomFileInput=e()
}(this,function(){
	"use strict";
	var f={
	...
	a=function(t){
		var e=t.bsCustomFileInput.defaultText,n=t.parentNode.querySelector(f.CUSTOMFILELABEL);
		n&&(o(n).innerHTML=e)
	},
	n=!!window.File,
	i=function(t){
	...
	function d(){
		for(var t=[].slice.call(
			this.querySelectorAll(f.INPUT)
		).filter(function(t){
			return!!t.bsCustomFileInput
		}),e=0,n=t.length;e<n;e++)a(t[e])
	}
	var p="bsCustomFileInput",y="reset",m="change";
	return{
		init:function(t,e){
			void 0===t&&(t=f.CUSTOMFILE),
			void 0===e&&(e=f.FORM);
			for(var n,o,i,r=[].slice.call(
		...
		destroy:function(){
			for(var t=[].slice.call(
				document.querySelectorAll(f.FORM)
			).filter(function(t){
				return!!t.bsCustomFileInput
			}),e=[].slice.call(
...
(function(i){
	...
	i(function(){
		...
		i('.bd-content [href="#"]').click(function(t){t.preventDefault()});
		...
		i("figure.highlight, div.highlight").each(function(){
			...
			i(this).before(t);
			i(".btn-clipboard").tooltip().on("mouseleave",function(){i(this).tooltip("hide")})
		});
		var t=new ClipboardJS(".btn-clipboard",{
			target:function(t){return t.parentNode.nextElementSibling}
		});
...
(function(){
	...
	function e(){
		...
		if(typeof t==="undefined"){return 11}
		if(t<9){return 8}
		return t
	}
